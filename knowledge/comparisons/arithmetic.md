...
| Public constant u32 AND | `u32_and_constant(value)` | 628 | 13-byte/4-item witness; 272-item peak; 256-item table |
...
for a public mask. It uses 628 locking bytes, a 13-byte/4-item witness, and a
