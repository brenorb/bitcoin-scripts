...
| Public constant u32 subtraction | `u32_sub_constant(value)` | 137 | 9-byte/4-item witness; 10-item peak; no hints |
...
subtrahend: the checked four-limb adapter uses 137 locking bytes, a
representative 9-byte/4-item witness, and a 10-item strict peak, versus 77
