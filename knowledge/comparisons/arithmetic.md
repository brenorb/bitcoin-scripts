...
| Public constant u32 XNOR | `u32_xnor_constant(value)` | 686 | 13-byte/4-item witness; 272-item peak; 256-item table |
...
public mask. It uses 686 locking bytes, a 13-byte/4-item witness,
