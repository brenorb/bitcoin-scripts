...
intentionally returns 32 substituted nibbles. A caller must compare or consume
all outputs and leave exactly one truthy stack item. `aes128_sub_bytes` checks
