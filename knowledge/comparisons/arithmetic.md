...
| Public constant u32 OR | `u32_or_constant(value)` | 776 | 13-byte/4-item witness; 272-item peak; 256-item table |
...
a public mask. It uses 776 locking bytes, a 13-byte/4-item witness, and a
