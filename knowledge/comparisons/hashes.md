...
| RIPEMD-160 u32 midstate | 64-byte prefix + 16-byte suffix | <!-- metric:ripemd160_u32_80_midstate -->TODO<!-- /metric:ripemd160_u32_80_midstate --> | locally-reproduced | Requires an authenticated one-block midstate; 80-bit ideal collision bound |
